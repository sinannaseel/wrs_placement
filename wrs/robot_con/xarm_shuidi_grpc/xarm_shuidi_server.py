...
import wrs2.drivers.xarm.wrapper.xarm_api as arm
import wrs2.robot_con.xarm_shuidi_grpc.shuidi.shuidi_robot as agv
import wrs2.robot_con.xarm_shuidi_grpc.xarm_shuidi_pb2 as aa_msg  # aa = arm_agv
