import copy
import math
import wrs2.modeling.dynamics.bullet.bdbody as bdb
from wrs2.visualization.panda.world import ShowBase
...
if __name__ == "__main__":
    import os
    import numpy as np
    from wrs2 import basis, basis as rm, modeling as gm
